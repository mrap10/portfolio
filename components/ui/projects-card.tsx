...
const colorThemes = {
  emerald: {
    ...
    languageBorder:
      "hover:border-emerald-500 hover:shadow-[0_0_10px_rgba(16,185,129,0.5)]",
    liveBg:
      "from-emerald-600/20 to-green-600/20 hover:from-emerald-600/40 hover:to-green-600/40",
  ...
  amber: {
    ...
    languageBorder:
      "hover:border-amber-500 hover:shadow-[0_0_10px_rgba(245,158,11,0.5)]",
    liveBg:
      "from-amber-600/20 to-yellow-600/20 hover:from-amber-600/40 hover:to-yellow-600/40",
  ...
  cyan: {
    ...
    languageBorder:
      "hover:border-cyan-500 hover:shadow-[0_0_10px_rgba(6,182,212,0.5)]",
    liveBg:
      "from-cyan-600/20 to-blue-600/20 hover:from-cyan-600/40 hover:to-blue-600/40",
  ...
  red: {
    ...
    languageBorder:
      "hover:border-red-500 hover:shadow-[0_0_10px_rgba(239,68,68,0.5)]",
    liveBg:
      "from-red-600/20 to-rose-600/20 hover:from-red-600/40 hover:to-rose-600/40",
  ...
  violet: {
    ...
    languageBorder:
      "hover:border-violet-500 hover:shadow-[0_0_10px_rgba(139,92,246,0.5)]",
    liveBg:
      "from-violet-600/20 to-purple-600/20 hover:from-violet-600/40 hover:to-purple-600/40",
  ...
  indigo: {
    ...
    languageBorder:
      "hover:border-indigo-500 hover:shadow-[0_0_10px_rgba(99,102,241,0.5)]",
    liveBg:
      "from-indigo-600/20 to-blue-600/20 hover:from-indigo-600/40 hover:to-blue-600/40",
  ...
  rose: {
    ...
    languageBorder:
      "hover:border-rose-500 hover:shadow-[0_0_10px_rgba(244,63,94,0.5)]",
    liveBg:
      "from-rose-600/20 to-pink-600/20 hover:from-rose-600/40 hover:to-pink-600/40",
    liveBorder: "hover:border-rose-500",
    liveShadow: "hover:shadow-[0_0_15px_rgba(244,63,94,0.4)]",
  },
  neutral: {
    shadow: "hover:shadow-[0_0_30px_rgba(107,114,128,0.3)]",
    gradient: "from-neutral-500/10 via-transparent to-gray-500/10",
    titleHover: "group-hover:text-neutral-400",
    iconHover: "group-hover:text-neutral-400",
    languageBorder:
      "hover:border-neutral-500 hover:shadow-[0_0_10px_rgba(107,114,128,0.5)]",
    liveBg:
      "from-neutral-600/20 to-gray-600/20 hover:from-neutral-600/40 hover:to-gray-600/40",
    liveBorder: "hover:border-neutral-500",
    liveShadow: "hover:shadow-[0_0_15px_rgba(107,114,128,0.4)]",
  },
};
...
export default function ProjectsCard({
  ...
  return (
    <div
      className={`group flex flex-col border border-neutral-700 rounded-lg p-6 gap-4 max-w-md relative overflow-hidden transition-all duration-300 hover:border-neutral-500 ${theme.shadow} hover:-translate-y-1 bg-neutral-900/50 backdrop-blur-sm`}>
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div
          className={`absolute inset-0 bg-linear-to-br ${theme.gradient} blur-xl`}></div>
      </div>

      <div className="relative z-10 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h1
            className={`text-2xl font-bold ${theme.titleHover} transition-colors duration-300`}>
            {title}
          </h1>
          {icon && (
            <div
              className={`text-neutral-500 ${theme.iconHover} transition-colors duration-300`}>
              {icon}
            </div>
          )}
        </div>
        <p className="text-justify text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
          {description}
        </p>
        <div>
          {languages.length > 0 && (
